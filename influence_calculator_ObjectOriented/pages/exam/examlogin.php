        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="content">
                    ...
                    <div class="alert"></div>
                    <div class="title">
                        Login your Account to Start Exam
                    </div>
                    <form action="../../inc/exam.include.php" method="POST">
            ...
            ?>
                ...
                <div class="name" style="width:100%;">
                    <div class="name" style="width:100%; text-align:center;font-size:1.5rem;">⚠️You haven't registered or logged in your account yet</div><br>
                    <div class="name" style="text-align:center;font-size:1.5rem;">Your have to be registered or logged in before you can proceed to exam registration.</div>
                    <br>

                    <div class="name" style="width:100%; display:flex; justify-content:center;">
                        <p>
                            <a href="../Registration/signup.php" style="text-align:center;font-size:1.5rem;">Register Now</a><br>
                            <a href="../../index.php" style="text-align:center; font-size:1.5rem;">Back</a>
                        </p>
                    </div>
                </div>
            <?php
